...
- consplan-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- consplan-ui: main application module, development time
- consplan-production: module that produces a production mode WAR for deployment
